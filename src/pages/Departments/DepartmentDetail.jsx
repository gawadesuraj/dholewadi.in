    ...
    return (
      <div className="container py-12">
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-4">विभाग सापडला नाही</h1>
          <p>विनंती केलेला विभाग सापडला नाही.</p>
        </div>
      </div>
    );
  }
              ...
              <div className="p-6">
                ...
                <div className="text-sm space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span>सकाळी १०:०० - सायं ५:००</span>
                  </div>
                  <div className="flex justify-between">
                    <span>शनिवार</span>
                    <span>सकाळी १०:०० - दुपारी २:००</span>
                  </div>
                  <div className="flex justify-between">
                    <span>रविवार</span>
                    <span>सुट्टी</span>
