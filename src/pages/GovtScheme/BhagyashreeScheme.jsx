...
function BhagyashreeScheme() {
          const breadcrumbs = [ { label: "भागयश्री योजना", href: null } ];
  ...
  return (
    <div className="min-h-screen relative bg-gray-50 pb-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-5xl mx-auto bg-white/95 shadow-xl backdrop-blur-sm rounded-b-3xl border border-gray-200 overflow-hidden">
        ...
        {/* Header Section */}
        <div className="relative bg-gradient-to-r from-violet-700 to-fuchsia-700 p-8 sm:p-12 text-center text-white rounded-3xl">
